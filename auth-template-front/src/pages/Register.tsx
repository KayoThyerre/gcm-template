...
export function Register() {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center md:justify-end md:pr-24 lg:pr-32 bg-cover bg-center bg-no-repeat bg-[url('/register-hero.png')] dark:bg-[url('/register-hero-dark.png')] relative"
    >
      <button
        type="button"
        onClick={toggleTheme}
