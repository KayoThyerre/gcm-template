...
export function Login() {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat bg-[url('/login-hero.png')] dark:bg-[url('/login-hero-dark.png')] relative"
    >
      <button
        type="button"
        onClick={toggleTheme}
